...
windows=`echo "0.55 0.60 0.65 0.70 0.75 0.80 0.85 0.90 0.95  1.00"`
for i in $windows
do
cd $i
...
pmemd.cuda -i eqnpt.in -c heat.rst7 -p ti.parm7 -O -o eqnpt.out -inf eqnpt.info -e eqnpt.en -r eqnpt.rst7 -x eqnpt.nc -l eqnpt.log
