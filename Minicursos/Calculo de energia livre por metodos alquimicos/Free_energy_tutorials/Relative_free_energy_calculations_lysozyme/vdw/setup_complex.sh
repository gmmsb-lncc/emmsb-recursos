...
vdw_crg=":163@H01 | :164@O01,H01"

vdw=" ifsc=1, scmask1=':163@H01', scmask2=':164@O01,H01', crgmask='$vdw_crg'"
...
for system in complex; do
  ...
  for step in vdw; do
    ...
    for w in $windows; do
      ...
      (
        cd $w
        ln -sf $setup_dir/lyz_bnz_phn_vdw.parm7 ti.parm7
        ln -sf $setup_dir/lyz_bnz_phn_vdw.rst7  ti.rst7
      )
    done
