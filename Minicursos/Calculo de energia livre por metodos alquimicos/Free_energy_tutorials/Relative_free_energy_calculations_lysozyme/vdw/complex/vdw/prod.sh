...
windows=`echo "0.00 0.05 0.10 0.15 0.20 0.25 0.30 0.35 0.40 0.45 0.50 0.55 0.60 0.65 0.70 0.75 0.80 0.85 0.90 0.92 0.94 0.95 1.00"`
for i in 0.95 1.00
do
cd $i
export AMBERHOME=~/sortware/amber22
source ~/software/amber22/amber.sh

export CUDA_VISIBLE_DEVICES=1

pmemd.cuda -i heat.in -c ti.rst7 -ref ti.rst7 -p ti.parm7  -o heat.out -inf heat.info -e heat.en -r heat.rst7 -x heat.nc -l heat.log
